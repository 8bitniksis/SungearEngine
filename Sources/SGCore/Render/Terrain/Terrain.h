...
namespace SGCore
{
    ...
    struct SGCORE_EXPORT Terrain : ECS::Component<Terrain, const Terrain>
    {
        ...
        void generate(const AssetRef<IMeshData>& terrainMeshData, std::int64_t patchesCountX, std::int64_t patchesCountY, std::int64_t patchSize) noexcept;
         ...
         */
        void generatePhysicalMesh(const Mesh& terrainMesh, std::int32_t stepSize) noexcept;
