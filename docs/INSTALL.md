...
`smoke_<gapi>_<ширина>x<высота>.png`. ⚠️ Размер кадра равен разрешению
...
Проверено 2026-08-17 (NVIDIA, 1920×1080): GL4 детерминирован — повторный
запуск даёт 0 % расхождений; `--gapi gl46` даёт чёрный кадр (бэкенд сломан,
см. задачу 1.6b плана).
